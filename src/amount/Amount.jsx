...
function TotalAmount({getAmount, activeValut, data, useFilterUserKoala, useFilterUserPanda, userFilterHandlerPanda, userFilterHandlerKoala}){
    ...
    return(
        ...
        <img className={`w-7 h-7 rounded-full border-2 hover:bg-greyBG ${useFilterUserPanda && 'bg-greyBG'} border-pink-100`} src={panda} alt="" />
        </button>
        <button onClick={()=>filterKoala()}>
        <img className={`w-7 h-7 rounded-full border-2 hover:bg-greyBG ${useFilterUserKoala && 'bg-greyBG'} border-pink-100`} src={koala} alt="" />
        </button>
        </div>
        </div>
